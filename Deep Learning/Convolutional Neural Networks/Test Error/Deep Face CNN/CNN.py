...
def cross_validation():
    ...
    for conv_pool in range(len(nb_conv_pool)):
        for nh in range(len(nb_neurons)):
            ...
            str_name_directory = '/media/clodoaldo/Dados/Jonnathann/Experimentos Novos/Deep Learning/Convolutional Neural Networks/Test Error/Deep Face CNN/RESULT-CNN-DATASET:'+str(database[0])
            #Create directory
