...
for Tec=1:length(TecRed)
    for car=1:length(Combinacoes)
        load(strcat('D:\Bases De Dados\Shumla\Bases Construidas\FaceIris\',Combinacoes{car},'\Curvelet\RedDim\',TecRed{Tec},...
            '\SDUMLA_Iris+Face_',Combinacoes{car},'_Curvelet_pessoa1_',TecRed{Tec},'.mat'));
        ...
        for parte=1:Partes
            ...
            for p=1:pessoas
                load(strcat('D:\Bases De Dados\Shumla\Bases Construidas\FaceIris\',Combinacoes{car},'\Curvelet\RedDim\',TecRed{Tec},...
                    '\SDUMLA_Iris+Face_',Combinacoes{car},'_Curvelet_pessoa',int2str(p),'_',TecRed{Tec},'.mat'));
                if parte<Partes
            ...
            for p=1:pessoas
                arq=strcat('D:\Bases De Dados\Shumla\Bases Construidas\FaceIris\',Combinacoes{car},'\Curvelet\RedDim\',TecRed{Tec},...
                    '\SDUMLA_Iris+Face_',Combinacoes{car},'_Curvelet_pessoa',int2str(p),'_',TecRed{Tec},'.mat')
                load(arq);
                if parte<Partes
