function [accuracy, predict] = MLP(Xtr, Ytr, Xte, Yte, nh, epochs)
...
[accuracy, predict] = test_MLP(Xte, Yte, A, B);
end
...
function [accuracy, Y] = test_MLP(Xte, Yte, A, B)
...
predict = [round(convert(Y)), convert(Yte)];
